...
Model(
    ...
    secondary= [
        ...
        ApplyFunctionOnRange(column='primary_output_sum', target='primary_output', range=[40, 0], function='sum'),
        AndComparativeAgroRule(
            column='spo', 
            rules=[
    ...
    primary_output_rule=[
        ...
        ApplySusceptibility(column='primary_output',   target='windowed_risk_primary', select_fnc='max', grouping_fnc='sum', susceptibility_window=3)
    ...
    secondary_output_rule=[
        ...
        ApplySusceptibility(column='secondary_output',     target='windowed_risk_secondary', select_fnc='max', grouping_fnc='sum', susceptibility_window=3)

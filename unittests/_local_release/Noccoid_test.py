...
class NoccoidModelTest(unittest.TestCase):
    maxDiff = None  

    """
        NoccoidModelTest:
            - test_noccoid_model_results_success: Check if results have been produced.
    """

    def setUp(self) -> None:
        self.data_folder = "unittests/_local_release/data/NoccoidTest/"
    ...
    def test_noccoid_model_results_success(self):
        engine = MosaicEngine(input_file="noccoid_model_local.py", DEBUG=False)
        engine.run()

...
class NoccytModelTest(unittest.TestCase):
    maxDiff = None  

    """
        NoccytModelTest:
            - test_noccyt_model_results_success: Check if results have been produced.
    """

    def setUp(self) -> None:
        self.data_folder = "unittests/_local_release/data/NoccytTest/"
    ...
    def test_noccyt_model_results_success(self):
        engine = MosaicEngine(input_file="noccyt_model_local.py", DEBUG=False)
        engine.run()

...
class WherugModelTest(unittest.TestCase):
    maxDiff = None  
    ...
    def setUp(self) -> None:
        self.data_folder = "unittests/_local_release/data/WherugTest/"
    ...
    def test_wherug_model_results_success(self):
        engine = MosaicEngine(input_file="wherug_model_local.py", DEBUG=False)
        engine.run()

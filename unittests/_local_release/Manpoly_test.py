...
class ManpolyModelTest(unittest.TestCase):
    maxDiff = None  

    """
        ManpolyModelTest:
            - test_manpoly_model_results_success: Check if results have been produced.
    """

    def setUp(self) -> None:
        self.data_folder = "unittests/_local_release/data/ManpolyTest/"
    ...
    def test_manpoly_model_results_success(self):
        engine = MosaicEngine(input_file="manpoly_model_local.py", DEBUG=False)
        engine.run()

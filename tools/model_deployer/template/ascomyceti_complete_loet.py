    ...
    primary=[
        ...
        AndComparativeAgroRule(
            ...
            rules=[
                ...
                SimpleComparativeRule(column='cond_rain', target='rain',condition='loet<dispac_cond_rain>')
        ]),
        AndComparativeAgroRule(
            column='cond_t_2', 
            rules=[
    ...
    secondary= [
        ...
        AndComparativeAgroRule(
            ...
            rules=[
                    ...
                    SimpleComparativeRule(column='cond_lw_2',  target='leafWetness',condition='loet<spo_cond_lw_2>')
                ], debug=True),
        AndComparativeAgroRule(
            column='cond_t_4', 
            rules=[
        ...
        AndComparativeAgroRule(
            ...
            rules=[
                    ...
                    SimpleComparativeRule(column='cond_rain_2',  target='rain',condition='loet<dispcon_cond_rain_2>')
                ], debug=True),

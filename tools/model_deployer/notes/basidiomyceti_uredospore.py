...
Metadata(
    ...
    model='basidiomyceti_uredospore_model',
    version='1.0.0',
    reference_crop='',
    reference_disease='',
    ...
    primary=[
        ...
        AndComparativeAgroRule(
            ...
            rules=[
                    ...
                    OrComparativeAgroRule(
                        ...
                        rules=[
                            SimpleComparativeRule(column='cond_w_2',       target='windSpeed',condition='goet2.5'),
        ...
        AndComparativeAgroRule(
            ...
            rules=[
                ...
                SimpleComparativeRule(column='cond_lw_2',     target='leafWetness',condition='goet4.0')
        ]),
